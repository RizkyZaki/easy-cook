...
public class EasyCook extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        homeTab.setContent(loadFXML("/resources/Home.fxml"));

        // Tab Resep Tersimpan
        Tab savedRecipesTab = new Tab("Resep Saya");
        savedRecipesTab.setContent(loadFXML("/resources/SavedRecipes.fxml"));

        // Tab Resep Terjadwal
        Tab scheduledRecipesTab = new Tab("Resep Terjadwal");
        scheduledRecipesTab.setContent(loadFXML("/resources/ScheduledRecipes.fxml"));
